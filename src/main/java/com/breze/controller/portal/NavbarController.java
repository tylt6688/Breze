...
public class NavbarController extends BaseController {
    ...
    @BrezeLog("分页获取导航标题")
    @GetMapping("/page")
    public Result<Page<Navbar>> findPage(String titleName,Long parentId){
    ...
    @BrezeLog("获取导航标题")
    @GetMapping("/select")
    public Result<List<NavbarVO>> findAllData(Long flag){
    ...
    public Result<Navbar> selectNavbar(@PathVariable Long id) {
    ...
    public Result<List<NavbarTitleVO>> findDataByFlag(@PathVariable Long flag) {
    ...
    @BrezeLog("新增导航标题")
    @PostMapping("/insert")
    public Result<String> saveMain(@Validated @RequestBody NavbarDTO navbarDTO) {
    ...
    @BrezeLog("修改导航标题")
    @PostMapping("/update")
    public Result<String> updateMain(@Validated @RequestBody NavbarDTO navbarDTO) {
