...
-- ----------------------------
-- Table structure for tb_maincontent
-- ----------------------------
DROP TABLE IF EXISTS `tb_maincontent`;
CREATE TABLE `tb_maincontent`  (
...
-- ----------------------------
-- Table structure for tb_modecard
-- ----------------------------
DROP TABLE IF EXISTS `tb_modecard`;
CREATE TABLE `tb_modecard`  (
